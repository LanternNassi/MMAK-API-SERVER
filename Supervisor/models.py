...
class Products(models.Model):
    ...
    selling_price = models.CharField(db_column='Selling_price', max_length=255,  blank=True, null=True)  # Field name made lowercase.
    ...
    added_by = models.CharField(db_column='Added_by', max_length=255,  blank=True, null=True)  # Field name made lowercase.
...
class TransactionDetails(models.Model):
    ...
    dea_cust_name = models.CharField(max_length=255,  blank=True, null=True)
    added_date = models.DateTimeField()
    added_by = models.CharField(max_length=255,  blank=True, null=True)
...
class TransactionTracker(models.Model):
    ...
    paid_amount = models.CharField(db_column='Paid_amount', max_length=255,  blank=True, null=True)  # Field name made lowercase.
    added_date = models.DateTimeField(db_column='Added_date')  # Field name made lowercase.
    updated_by = models.CharField(db_column='Updated_by', max_length=255,  blank=True, null=True)  # Field name made lowercase.
...
class Transactions(models.Model):
    ...
    added_by = models.CharField(max_length=255,  blank=True, null=True)
    paid_amount = models.IntegerField(db_column='Paid_amount',  blank=True, null=True)  # Field name made lowercase.
    return_amount = models.IntegerField(db_column='Return_amount', blank=True, null=True)  # Field name made lowercase.
    total_profit = models.IntegerField(db_column='Total_Profit',   blank=True, null=True)  # Field name made lowercase.
    paid = models.CharField(db_column='Paid', max_length=255,  blank=True, null=True)  # Field name made lowercase.
    taken = models.CharField(db_column='Taken', max_length=255,  blank=True, null=True)  # Field name made lowercase.
